...
/*  private int start;
  private int end;*/
    ...
    public String getHighLabel(){
        String label = this.type;
        if (label.equals("REACTION_PRODUCT")){
            return "COMPOUND";
        }else if (label.equals("STARTING_MATERIAL")){
            return "COMPOUND";
        }else if (label.equals("SOLVENT")){
            return "COMPOUND";
        }else if (label.equals("REAGENT_CATALYST")){
            return "COMPOUND";
        }else if (label.equals("OTHER_COMPOUND")){
            return "COMPOUND";
        }else if (label.equals("TIME")){
            return "CONDITIONS";
        }else if (label.equals("TEMPERATURE")){
            return "CONDITIONS";
        }else if (label.equals("YIELD_OTHER")){
            return "YIELD";
        }else if (label.equals("YIELD_PERCENT")){
            return "YIELD";
        }else if (label.equals("EXAMPLE_LABEL")){
    ...
    {
        return id + "|" + type + "|" + getLocationsString(" ", ";") + "|" + string;
    }
