...
public class CompareEntities
{
	...
	public static TreeMap<String, String> getMapping(String fp) throws IOException {
		TreeMap<String, String> mapping = new TreeMap<>();
		BufferedReader mappingFile = new BufferedReader(new FileReader(fp));
		mappingFile.readLine();
		String line;
		while ((line = mappingFile.readLine()) != null){
			String[] array = line.split("\t");
			mapping.put(array[1], array[0]);
		}
		return mapping;
	}
